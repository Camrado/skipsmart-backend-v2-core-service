...
public class User : Entity {
     ...
     private User(Guid id, FirstName firstName, LastName lastName, Email email, bool isEmailVerified, Password password, Guid groupId)
         : base(id) 
     {
         FirstName = firstName;
         LastName = lastName;
     ...
     public static User Create(FirstName firstName, LastName lastName, Email email, Password password, Guid groupId) {
         var user = new User(Guid.NewGuid(), firstName, lastName, email, false, password, groupId);
